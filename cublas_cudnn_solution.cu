...
int main() {
    ...
    cublasSgemm(cublasHandle, CUBLAS_OP_N, CUBLAS_OP_N, rowsA, colsB, colsA, &alpha, d_A, rowsA, d_B, rowsB, &beta, d_C, rowsA);
    ...
    cudnnActivationForward(cudnnHandle, activationDesc, &alpha, tensorDesc, d_C, &beta, tensorDesc, d_C);
